...
$sql = "INSERT INTO imdb_ep (mo_tv_ep, imdb_id, title, year_r, genre, plot, rating, number_of_people, moviemeter, director, writers, artists, image_url, ep, tv_id, youtube_t) VALUES ('$mo_tv_ep', '$imdb_id', '$title', '$year_r', '$genre', '$plot', '$rating', '$number_of_people', '$moviemeter', '$director', '$writers', '$artists', '$image_url', '$ep', '$tv_id', '$youtube_t')";
if(mysqli_query($conn, $sql)){
    echo 'Records added successfully.<meta http-equiv="refresh" content="0;url=movie_tv.php" />';
} else{
